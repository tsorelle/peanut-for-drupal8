    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const module of all) {
            ...
            if (!notOnNpm.has(module)) {
                ...
                ensureDir(dir);
                fs.writeFileSync(path.join(dir, "index.d.ts"), yield globalDefinitionText(module));
